// To parse this data:
//
//   import { Convert, GifsHTTP } from "./file";
//
//   const gifsHTTP = Convert.toGifsHTTP(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface GifsHttp {
  data: Datum[];
  meta: Meta;
...
export class Convert {
  public static toGifsHTTP(json: string): GifsHttp {
    return cast(JSON.parse(json), r("GifsHTTP"));
  }

  public static gifsHTTPToJson(value: GifsHttp): string {
    return JSON.stringify(uncast(value, r("GifsHTTP")), null, 2);
  }
}
